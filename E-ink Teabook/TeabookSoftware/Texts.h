...
const char text2[] PROGMEM = "The secret to a\nwell balanced life \nis a cup of tea \nin one hand and \na good book\nin the other.";
...
const char text16[] PROGMEM = "Success is not \na destination; \nit's a journey \nof continuous growth \nand learning.";
...
const char text54[] PROGMEM = "But if you\nnever try you\nnever know\njust what\nyou're worth.";
...
const char text76[] PROGMEM = "Your attitude \ndetermines your \naltitude; \n\nstay positive!";
...
const char text90[] PROGMEM = "It's a beautiful\nday to be \ninefficient.";
const char text91[] PROGMEM = "You are the author \nof your story; \nwrite it with \ncourage, love, \nand resilience.";
...
const char text98[] PROGMEM = "Take time for \nself-reflection; \nit's the key to \nunderstanding your \ntrue desires.";
